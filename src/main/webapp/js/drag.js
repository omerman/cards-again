...
Draggabilly.prototype._create = function() {
  ...
  this._setInitialPosition(style);
  this.enable();
  this.setHandles();

};

Draggabilly.prototype._setInitialPosition = function(style){
	this.initX = style.x || "";
	this.initY = style.y || "";
};
...
Draggabilly.prototype.resetLeftTop = function() {
	  this.element.style.left = this.initX;
	  this.element.style.top  = this.initY;
};
